...
Optional: `AGENT_IMPL` (`graph` or `native`), `INTENT_ROUTER_ENABLED`, the `LANGCHAIN_*` tracing vars, and the `UPSTASH_VECTOR_*` + `EPISODIC_MEMORY_ENABLED` flags for the L2 layer.
